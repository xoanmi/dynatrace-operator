...
import (
	webhook "github.com/Dynatrace/dynatrace-operator/src/webhook"
...
type mockConstructorTestingTNewPodMutator interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewPodMutator(t mockConstructorTestingTNewPodMutator) *PodMutator {
	mock := &PodMutator{}
	mock.Mock.Test(t)
